...
class TokenizerManager(TokenizerControlMixin, TokenizerManagerScoreMixin):
    ...
    async def generate_request(
        ...
        if isinstance(obj, GenerateReqInput):
            obj.encoder_upstream_session_id = (
    ...
    async def _stream_one_response(
        ...
        while True:
            ...
            glm_interleaved = is_stream and get_serving().glm_stream_speculated_tokens
            if incremental_stream and len(out_list) > 1 and not glm_interleaved:
        ...
        for i, rid in enumerate(recv_obj.rids):
            ...
            if beam_out_dict is not None:
                ...
                if is_stream:
                    ...
                    elif state.finished or get_serving().glm_stream_speculated_tokens:
                        out_dict = {
                            "text": state.get_text(),
